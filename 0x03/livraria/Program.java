...
public class Program {
    public static void main(String[] args) {
        ...
        try {
            ...
            System.out.println(ex.getMessage() + "\n"); // Deve imprimir "Nome de autor invalido"
        }

        try {
            Livro livro2 = new Livro(
                    "ab", // Título com menos de 3 caracteres
                    "Jane Doe",
                    15.99);
            ...
            System.out.println(ex.getMessage() + "\n"); // Deve imprimir "Titulo de livro invalido"
        }
        ...
        try {
            ...
            System.out.println(ex.getMessage() + "\n"); // Deve imprimir "Preco de livro invalido"
        }
    }
}