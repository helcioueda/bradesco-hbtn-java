...
public class Program {
    public static void main(String[] args) {
        ...
        Pedido pedido1 = new Pedido(1, 1500, 234.90); // 1.5kg
        Pedido pedido2 = new Pedido(2, 600, 124.00);  // 0.6kg
        Pedido pedido3 = new Pedido(3, 3000, 53.00);  // 3kg
        Pedido pedido4 = new Pedido(4, 7000, 300.00); // 7kg
